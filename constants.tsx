...
export const STATUS_LABELS: Record<string, string> = {
  [ProjectStatus.FELMERES]: 'Felmérés',
  [ProjectStatus.ARAJANLAT]: 'Árajánlat',
  [ProjectStatus.KIVITELEZES]: 'Kivitelezés',
  [ProjectStatus.KESZ]: 'Kész'
};

export const STATUS_COLORS: Record<string, string> = {
  [ProjectStatus.FELMERES]: 'bg-blue-100 text-blue-700 border-blue-200',
  [ProjectStatus.ARAJANLAT]: 'bg-purple-100 text-purple-700 border-purple-200',
  [ProjectStatus.KIVITELEZES]: 'bg-orange-100 text-orange-700 border-orange-200',
  [ProjectStatus.KESZ]: 'bg-green-100 text-green-700 border-green-200'
};
